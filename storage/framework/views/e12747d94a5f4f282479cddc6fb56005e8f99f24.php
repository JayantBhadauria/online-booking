                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="employee_id" class="form-control custom-control">
                                                <?php $__currentLoopData = $employees; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $employee): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($employee->id); ?>"><?php echo e($employee->first_name.' '. $employee->last_name. ' ('.date('g:iA',strtotime($employee->workingHour->first()->start_time)).'-'.date('g:iA',strtotime($employee->workingHour->first()->finish_time)).')'); ?></option>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            </select>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            ...
                                            <input type="time" class="form-control custom-control" id="start_time" name="start_time" value="<?php echo e(old('start_time')); ?>" required>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control custom-control" style="resize: none" id="comments" value="<?php echo e(old('comments')); ?>" name="comments" maxlength="150" required><?php echo e(old('comments')); ?></textarea>
                                        </div>
                                    </div>
                                </div>
