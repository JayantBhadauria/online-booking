    ...
    <div class="col-sm-12 col-mobile">
        <div class="board-box">
            <div class="board-title">
                <h2>List of all employees <a href="<?php echo e(route('employees.create')); ?>" class="add-new-employee"><span  style="float: right;padding-right: 20px;" class="fa fa-plus"></span></a></h2>
            </div>
                    ...
                    <table class="table table-hover">
                        ...
                        <?php $__currentLoopData = $employees; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $employee): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                ...
                                <td><button class="btn btn-default btn-lg" onclick='window.location.href="<?php echo e(route('employees.show',$employee->id)); ?>"'>
                                        <span class="glyphicon glyphicon-eye-open"></span></button> </td>
                                <td><button class="btn btn-default btn-lg" onclick='window.location.href="<?php echo e(route('employees.edit',$employee->id)); ?>"'>
